  ...
  return (
    <article className="article">
      ...
      <p className="hiring">
        ...
        harum animi blanditiis. Pariatur, nisi quas? Odio, quis neque! Modi
        harum repellat consequuntur praesentium magnam reprehenderit eum dolores
        fugiat dolorem! Ad asperiores blanditiis, perferendis dignissimos
        repellat totam, dolor quasi quo ab soluta veritatis. Enim eaque qui
        impedit aspernatur corporis et temporibus accusantium blanditiis nihil
        porro nesciunt corrupti amet ullam eius quo laudantium reprehenderit
        dolor mollitia alias, voluptatem voluptas earum?
      </p>
    </article>
  );
};
